...
# ============================================
# VIDEO UPLOAD AND REELS ROUTES (NEW)
# ============================================
@app.route('/upload', methods=['GET', 'POST'])
@login_required
def upload_video():
"""Handle video upload and save metadata to database."""
...
@login_required
def reels_page():
"""Render the reels/video browsing page."""
return render_template('video.html', user=session.get('user'))

@app.route('/api/videos')
@login_required
def api_get_videos():
"""API endpoint to fetch videos with optional filters."""
...
@login_required
def api_get_courses():
"""API endpoint to get distinct course names from approved videos."""
...
@login_required
def admin_videos():
"""Admin page to view pending videos."""
...
# ============================================
# FILE UPLOAD ENDPOINT (for AI Tutor)
# ============================================
...
print("   8. 🎥 Video Upload & Sharing (NEW)")
print(f"{'='*70}")
...
print("🎬 Video Reels: http://localhost:5000/reels")
print("📤 Upload Video: http://localhost:5000/upload")
print(f"{'='*70}")
